...
# My_plaque.Launch_Simu(display_animation=True)

# plt.plot(My_plaque.actual_time_data, My_plaque.Interest_point_data_C_1, 'b-', label='Thermistance 1')
# plt.plot(My_plaque.actual_time_data, My_plaque.Interest_point_data_C_2, 'g-', label='Thermistance 2')
# plt.plot(My_plaque.actual_time_data, My_plaque.Interest_point_data_C_3, 'k-', label='Thermistance Laser')
